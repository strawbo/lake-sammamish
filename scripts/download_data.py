...
form_data.update({
    ...
    "ctl00$kcMasterPagePlaceHolder$c_YearDropDownList": "2021",
    "ctl00$kcMasterPagePlaceHolder$c_MonthStartDropDownList": "1",
    "ctl00$kcMasterPagePlaceHolder$c_EndMonthDropDownList": "12",
